...
import type ScreenshotEssaysPlugin from './ScreenshotEssaysPlugin';

export class SettingRenderer {
  private app: App;
  private plugin: ScreenshotEssaysPlugin;
  private containerEl: HTMLElement;
  private settingItems: SettingItem[];
  constructor(app: App, plugin: ScreenshotEssaysPlugin, containerEl: HTMLElement) {
    this.app = app;
    this.plugin = plugin;
